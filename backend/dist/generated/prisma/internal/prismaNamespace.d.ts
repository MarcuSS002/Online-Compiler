...
export declare const SubmissionsScalarFieldEnum: {
    readonly id: "id";
    readonly code: "code";
...
/**
 * Reference to a field of type 'SubmissionsStatus'
 */
export type EnumSubmissionsStatusFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'SubmissionsStatus'>;
/**
 * Reference to a field of type 'SubmissionsStatus[]'
 */
export type ListEnumSubmissionsStatusFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'SubmissionsStatus[]'>;
/**
